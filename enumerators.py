def enumerator():
    ...
    # You can use the given print() line as an example and change its variable names, but the returned phrases 
    # must be the same!
    ...
    # Create a list formed by the tuples (index, element), obtained through enumerating the indices of each 
    # character of the "Python" string.
    ...
    # You can solve it in different ways, but it will help you keeping mind some (if not all) the following 
    # elements:
